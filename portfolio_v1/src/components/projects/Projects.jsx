            ...
            <div key={index} className='app__work-item relative'>
              <div className="app__work-img relative rounded-lg overflow-hidden">
                ...
                <motion.div
                  ...
                  className='app__work-hover absolute top-0 left-0 w-full h-full flex justify-center items-center opacity-0 bg-black/50 hover:opacity-100 transition-opacity duration-300'
                >
                  <a href={project.projectLink} target='_blank' rel='noreferrer'>
                    <motion.div
                      whileHover={{ scale: [1, 0.9] }}
                      transition={{ duration: 0.25 }}
                      className='app__flex text-white'
                    >
                      <AiFillEye />
                    </motion.div>
                  </a>
              ...
              <div className='app__work-content mt-4'>
